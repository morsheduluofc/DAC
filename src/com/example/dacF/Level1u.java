...
public class Level1u extends Activity implements OnTouchListener, OnClickListener,SensorEventListener {
...
// 	        missflashed=true;
  ...
  public void callMe(){
	  if(notmissflashed==false && ftime==0){
			Toast.makeText(Level1u.this, "Miss the suggestion? Tap on the screen.", Toast.LENGTH_LONG).show();
	  }
   ...
   /*-------------Random Suggestion----------------------------------------*/ 
    void RandomCircle(){
        ...
        final float LOW_LEVEL=0.75f;
      	...
      	boolean test=checkCenterdistance();
  ...
  void validation(){
	  for(int j=0;j<row;j++){
		  ...
		  if(xbound<0 ||xbound>360 ||ybound<30 ||ybound>540){
			  Toast.makeText(Level1u.this, "Drawing is out of boundary", Toast.LENGTH_SHORT).show();
			  //tryagain();
			  drawAgain();
		  }
	  }
...
//       }else 
       ...
       if(stindication==1){
       Toast.makeText(Level1u.this, "Erro in starting point. Try again", Toast.LENGTH_SHORT).show();
       stindication=0;
       }else if(timeindication==1){
    	Toast.makeText(Level1u.this, "Too long time. Try again", Toast.LENGTH_SHORT).show();
    	timeindication=0;
       }else{
 	   Toast.makeText(Level1u.this, "Not close to the circle. Try again", Toast.LENGTH_SHORT).show();
       }
...
/*--------------------- Start 1----------------------------*/
   public boolean onTouch(View v, MotionEvent event) {
       ...
       if(drawenable==0){
    	   Toast.makeText(Level1u.this, "Wait!!", Toast.LENGTH_SHORT).show();
    	   return false;
       }else{
//    	   if(!missflashed){
//    		   notmissflashed=true;
